...
namespace Facade\Ignition\Facades {
     ...
     * @method static \Facade\FlareClient\Concerns\HasContext|\Facade\FlareClient\Flare|\Facade\FlareClient\Report context($key, $value)
     ...
     * @method static false|mixed handleError($code, $message, $file = '', $line = 0)
